document.addEventListener("DOMContentLoaded", function() {
    ...
    const styles = `
        ...
        .floating-theme-global {
            position: fixed; bottom: 30px; left: 30px; width: 45px; height: 45px; background-color: var(--text-color); color: var(--bg-color); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; z-index: 1000; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2); cursor: pointer; border: none; transition: transform 0.3s, background-color 0.3s, color 0.3s;
        }
        ...
        @media (max-width: 991px) {
            ...
            .floating-theme-global { bottom: 100px !important; left: 20px; width: 40px; height: 40px; }
        }
    `;
    ...
    // Aggiunge WhatsApp e Tema su TUTTE le pagine
    ...
    // 3. LOGICA DARK/LIGHT MODE GLOBALE
    ...
    // Carica SEMPRE Light Mode di default, a meno che l'utente non l'abbia già cambiata
